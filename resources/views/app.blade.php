...
<head>
    ...
    <title>@yield('title', 'Kaleungitan') | Admin Console</title>
...
<body class="bg-surface text-on-surface">
    ...
    <aside class="fixed left-0 top-0 h-full w-[260px] z-40 bg-surface-container-lowest shadow-sm">
        <div class="flex flex-col h-full">
            ...
            <div class="p-4">
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg text-error hover:bg-error-container/30 transition-colors">
